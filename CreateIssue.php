...
$qryp ="SELECT project_id,project_name FROM it_project";
$resp = mysql_query($qryp );

while ($gamep = mysql_fetch_row($resp)) {
echo("
<option value='$gamep[0]'>$gamep[1]</option>
"); 
}
mysql_close($con);
?>
...
mysql_query("INSERT INTO it_issue (type, status, issue_description,issue_user_created,issue_reopened,issue_time_created,issue_title,project_id )
VALUES ('$issue', '1', '$quote', '$a', '0',CURDATE(),'$title','$project')");
mysql_close($con);
